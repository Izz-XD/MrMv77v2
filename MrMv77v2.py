 #!/usr/bin/bash
# -*- coding: utf-8 -*-
# ------ [ BUY NJIR SUSAH BUAT NYA ] ------ #
Author    = 'MrMv77'
Facebook  = 'フォージ'
Syafii  = 100068397981838
Postingan = 254018450221419
...
def menu():
    ...
    print(f"{P}[3] Crack dari dump id privat")
						...
						with ThreadPoolExecutor(max_workers=30) as coeg:
							...
							for user in id:
								...
								if len(frist)>=6:
									...
									fii = [ "bissmilah", "anjing", "indonesia", "sayangkamu","katasandi","123456" ]
